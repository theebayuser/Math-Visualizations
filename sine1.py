...
class SineOfSumProof(Scene):
    def construct(self):
        ...
        # Specific Variable Colors
        C_VAR_A = RED_D      # Side a
        C_VAR_B = BLUE_D     # Side b
        C_SIDE_C = GOLD_D    # Side c (Base)
        ...
        EQ_LOWER_POS = DOWN * 2.4          # Pushed down from -2.2
        ...
        # Draw sides, labels, and angles together
        ...
        # Draw both altitudes at the same time
        self.play(
        ...
        # Draw rad_C at the same time as writing "2z"
        ...
        # Write "sinz=c/2/r" at the same time as splitting the angle arc in half
        self.play(
        ...
        # Highlight the radius label and transform at the same time
        ...
        # Move up and start drawing braces at the same time
        self.play(
        ...
        # Write equation, box, and label all at the same time
        self.play(Write(fit(eq_sine_1)), Create(sine_box), Write(sine_label))
        self.wait(0.5)
        
        # Highlight r again and transform at the same time
        ...
        # Highlight x, y, and z in the diagram when writing the equation
        self.play(
            Write(eq_angle),
        ...
        # Transform through intermediate step
        ...
        # Clear the board of everything except the core logic components
        self.play(
            ReplacementTransform(eq_c_sub, final_eq[0:1]), # "sin(x+y)"
            ReplacementTransform(eq_target, final_eq[1:]),  # "= sin y cos x + ..."
            FadeOut(eq_z_3),
            run_time=2
        )
        
        # Cooler box with rounded corners and translucent background - less wide
